...
class TrainSpeedTimer(pl.Callback):
    ...
    def on_train_batch_start(self, trainer, pl_module, batch, batch_idx):
        ...
        if self.last_batch_end is not None:
            ...
            # Log to prog-bar
            pl_module.log("train_timer/data_waiting", average_time, on_step=True, on_epoch=False, prog_bar=True, logger=True)
    ...
    def on_train_batch_end(self, trainer, pl_module, outputs, batch, batch_idx):
        ...
        # Log iter time
        pl_module.log("train_timer/single_batch", average_time, on_step=True, on_epoch=False, prog_bar=False, logger=True)
