...
proj_root = Path(__file__).parent.parent.parent.parent.parent.parent.parent
...
class SMPLXCamHead(nn.Module):
    def __init__(self, img_res=224):
        ...
        smplx_folder = proj_root / "inputs/checkpoints/body_models/smplx"

        self.smplx = SMPLX(smplx_folder, num_betas=11)
