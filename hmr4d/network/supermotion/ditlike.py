...
from hmr4d.network.base_arch.transformer.dit import TransformerDecoderDiT
...
class Network(nn.Module):
    ...
    def _build_transformer(self):
        layer = BasicDiTTransformerBlock(
        ...
        self.TransDecoder = TransformerDecoderDiT(layer, num_layers=self.num_layers)
